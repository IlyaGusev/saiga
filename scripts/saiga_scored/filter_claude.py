...
from scripts.saiga_scored.anthropic_wrapper import anthropic_completion
...
The standard but not ideal answers should get 5.
...
- When the bot answers with language mistakes.
...
def filter_claude(
    ...
    for i, r in enumerate(records):
        ...
        try:
            ...
            explanation = json.loads(answer)["explanation"]
        except Exception:
            print("FAIL")
            continue
        r["score"] = int(score)
        r["score_explanation"] = explanation
